...
* link:../use/cache-manage.html#view_cache_details[View cache details].
* link:../use/cache-manage.html#edit_a_cache[Change the export policy and resize a cache].
* link:../use/cache-manage.html#delete_a_cache[Delete a cache].
